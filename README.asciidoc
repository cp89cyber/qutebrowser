...
See the https://github.com/cp89cyber/qutebrowser/releases[GitHub releases
page] for available downloads and the link:doc/install.asciidoc[INSTALL] file for
detailed instructions on how to get qutebrowser running on Linux.
...
repository after running `scripts/dev/update_3rdparty.py`), or online
